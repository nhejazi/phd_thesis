...
\begin{enumerate}[itemsep=-1ex]
  \item clear, easily acessible, highly detailed documentation, including
   ...
   \item rigorous unit testing to assess computing and data structures (e.g.,
      functions, classes, and methods);
  \item automated continuous integration, ensuring accessibility across systems
       and constant monitoring of software quality; and
...
coming decades, we hope that statisticians are challenged by questions that
highlight the importance of software, including, for example, (1) in what way
a theorem (or similar mathematical result) can hope to impact science, except
through software, or (2) how software implementations can reveal important
insights about the computational bottlenecks of newly developed statistical
methodology. Recalling an anecdote of~\citet{buckheit1995wavelab}, we note that,
without continued investment in open source software standards, ``a year [will
continue to be] a long time in our business,'' as the application of existing
statistical methodology to newly produced datasets will be marked by the
...
methods described in this body of work. Written for the \texttt{R} programming
language~\citep{R}, the entire source code of each of these packages is
available on the collaborative programming platform, GitHub; moreover, all of
these packages are accompanied by a suite of unit tests and automated continuous
integration to ensure continuous quality checking.
