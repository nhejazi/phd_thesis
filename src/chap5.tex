...
investment in open source software standards, ``a year [will continue to be]
a long time in our business,'' as the application of existing statistical
...
the unrestricted source for each package is available on the GitHub platform for
collaborative programming; moreover, each package is accompanied by online
documentation, a suite of unit tests, and automated quality control through
