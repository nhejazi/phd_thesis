...
actional insights from modern, large-scale studies. Chapter~\ref{five} discusses
open source software packages for causal inference, which implement the
statistical methodology discussed prior. Chapter~\ref{six} concludes with
